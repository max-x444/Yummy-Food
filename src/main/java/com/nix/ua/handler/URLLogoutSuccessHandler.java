...
public class URLLogoutSuccessHandler implements LogoutSuccessHandler {
    private static URLLogoutSuccessHandler instance;
    private final RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();

    private URLLogoutSuccessHandler() {
    }

    public static URLLogoutSuccessHandler getInstance() {
        if (instance == null) {
            instance = new URLLogoutSuccessHandler();
        }
        return instance;
    }
